...
async function viewStoredFile(
  ...
  /*
    ...
    click event is still active.

    This prevents Android/Chrome popup blockers
    from blocking the PDF after IndexedDB finishes.
  */

  let pdfWindow = null;

  const fileRecordPromise =
    dbGet(
      FILE_STORE,
      fileId
    );
  ...
  /*
    Only open a new window for PDF.
    We don't know the type yet, so first
    check the stored record asynchronously.
  */

  try {
    const file =
      await fileRecordPromise;
    ...
    if (type === "pdf") {
      ...
      */
      ...
      /*
        Because this function is async, some browsers
        may block window.open.
      */
      ...
      if (pdfWindow) {
        ...
        /*
          Write a very small PDF loading page.
          Then navigate the tab to the blob URL.
        */
        ...
        /*
          ...
          Show a normal link inside the app.
      ...
      /*
        Keep URL alive for two minutes.
        Some Android PDF viewers need time
        to load the Blob URL.
      */
