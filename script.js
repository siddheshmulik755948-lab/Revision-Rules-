...
/* =========================================================
   ...
   Existing features + Exam Countdown + Progress
   ========================================================= */
...
function getSubjectProgress(subject) {
  ...
  const total = chapters.reduce(
    (sum, chapter) =>
      sum + getChapterProgress(chapter),
    0
  );
...
function getOverallProgress() {
  const chapters = state.subjects.flatMap(
...
function getExamCountdown() {
  ...
  const exam = dateFromISO(examDate);
  ...
  return `
    <section>
      ...
      <div
        ...
        <div class="muted">
          Independent progress of every chapter
        </div>
                  ...
                  .map(subject => {
                    ...
                    return `
                      <div class="chapter-progress-subject">
                        ...
                        <div class="progress-subject-title">
                          ${escapeHTML(subject.name)}
                        </div>
                                ...
                                <div
                                  ...
                                  <div class="row">
                                    ...
                                    <div
                                      ...
                                      <div
                                        class="title chapter-progress-name">
