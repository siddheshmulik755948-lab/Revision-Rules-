  ...
  try {
    for (const file of input.files) {
      ...
      const storedFile = {
        ...
        /*
         IMPORTANT:
         Store the actual Blob/File in IndexedDB.
         This is what allows PDF reopening later.
        */
        blob: file
      };
...
async function viewStoredFile(fileId) {
  try {
    ...
    /*
      Convert IndexedDB Blob into a temporary
      browser URL.
    */
    const blob =
    ...
    /*
      ...
      PDF will use the browser's built-in
      PDF viewer.
    */
    const newWindow =
      window.open(
    ...
    if (!newWindow) {
      /*
        If popup blocker blocks new tab,
    ...
    /*
      ...
      The browser still needs the Blob URL.
    */
    setTimeout(() => {
